...
Interpretation:
---------------------------------------------------------------------------------------------------------------------------
The chosen variables-Item Weight, Item Visibility, and Rating do not significantly predict sales. Visibility Optimization is a must to showcase product options to the consumer as per their individual preference which could help increase sales.
---------------------------------------------------------------------------------------------------------------------------
## Business Insights
---------------------------------------------------------------------------------------------------------------------------
